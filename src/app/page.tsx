...
const ETAPAS = [
  { icon: ClipboardEdit, titulo: "Responda", descricao: "14 perguntas objetivas sobre a realidade do seu RH hoje. Leva cerca de 10 minutos." },
  ...
  return (
    <div style={{ background: "var(--lightbg)" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", padding: "0 24px" }}>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", position: "relative", zIndex: 1, padding: "40px 0 60px" }}>
